...
> **Source material:** `3. AI_Engineer_Interview_Preparation/Enterprise RAG Platform/INTERVIEW_SCRIPT.md` — kept as a performance artefact: a full six-step script, minute by minute, with the lines that carry each step. Read the method first; rehearse from this.
